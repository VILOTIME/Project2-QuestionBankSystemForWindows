#include <iostream>
#include <conio.h> //include getch function
#include <sstream>
#include <Windows.h>
...
int SystemColor = 0; //系统颜色
int QuitAnswer = 1; //用来记录退出是否询问的状态

int middle = 38; //用于调整标题居中的位置
...
string int_to_string(int a) //整型转换成字符串
{
    string b;
    stringstream stream;
    stream << a;
...
void mode1() //选择模式
{
    ...
    form5("本次共" + int_to_string(d) + "道题, 答对" + int_to_string(num) + "道题");
...
void mode4() //设置选项
{
    ...
    cout << "2.系统颜色 ";
    gotoxy(14, 3);
    ColorChange(ent[QuitAnswer]);
    gotoxy(14, 4);
    cout << color[SystemColor];
